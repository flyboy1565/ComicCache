    ...
    <div ref={menuRef} style={{ position: 'relative' }}>
      ...
      {open && (
        <div style={{
          ...
          minWidth: '200px', background: '#fff', borderRadius: '10px',
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '10px', paddingBottom: '10px', borderBottom: '1px solid #edf2f7' }}>
            ...
            <span style={{
              ...
              borderRadius: '999px', background: user.role === 'admin' ? '#fff5f5' : '#edf2f7',
              color: user.role === 'admin' ? '#e53e3e' : '#718096',
            }}>
              ...
              {employees.length === 0 ? (
                ...
                employees.map((emp) => (
                  <div key={emp.id} style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '4px 0' }}>
                    ...
                    <span style={{ fontSize: '11px', color: '#a0aec0', marginLeft: 'auto' }}>{emp.email}</span>
                  </div>
                ))
              )}
            </div>
